public class UseLock
{
  ...
  static {
           L.addClause(se.chalmers.paragon.ActorList.newActorList(se.chalmers.paragon.Actor.newActorVariable(0), se.chalmers.paragon.Actor.newActorVariable(1)), se.chalmers.paragon.Atom.newAtom(L, se.chalmers.paragon.Actor.newActorVariable(1), se.chalmers.paragon.Actor.newActorVariable(0)));
         }
